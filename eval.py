...
#model_dir = open('model_dir.txt').readline() #chen
#vocab_path = model_dir + "/vocab"  #chen
...
#checkpoint_file = "D:\资源文档\文档\python\论文\情感分析\实验\sentimal-classification\cnn-text-classification-tf-master\runs\1517903153\checkpoints/model-24200"
graph = tf.Graph()
with graph.as_default():
    ...
    with sess.as_default():
        ...
        print("dir:{}".format(checkpoint_file))
